  ...
  */
  head: {
    ...
    meta: [
      ...
      { property: 'og:title', content: 'Serveless Week' },
      { property: 'og:site_name', content: 'Serveless Week' },
      ...
      { property: 'twitter:title', content: 'Serveless Week' },
    ...
    link: [
      ...
      { rel: 'icon', type: 'image/x-icon', href: '/banner.png' },
